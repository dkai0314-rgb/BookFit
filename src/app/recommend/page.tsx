                ...
                {mode === 'SELECT' && (
                    <div className="space-y-12 animate-fade-in-up">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            >
                                <div className="absolute top-4 right-4 opacity-20 group-hover:opacity-100 group-hover:text-accent transition-all text-primary" aria-hidden="true">
                                    <Brain size={32} />
                                </div>
                            ...
                            >
                                <div className="absolute top-4 right-4 opacity-20 group-hover:opacity-100 group-hover:text-[#FF5678] transition-all text-primary" aria-hidden="true">
                                    <Heart size={32} />
                                </div>
                    ...
                    <section className="space-y-8 animate-fade-in" aria-labelledby="taste-title">
                        ...
                        <div className="space-y-6 bg-secondary p-8 rounded-xl border border-border shadow-sm">
                            ...
                            <div className="space-y-3">
                                <label htmlFor="taste-input" className="text-base font-bold text-primary uppercase tracking-wider flex justify-between">
                                ...
                                <div className="flex flex-wrap gap-2" role="group" aria-label="관심 키워드 선택">
                                    {TASTE_TAGS.map(tag => (
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-full text-base transition-all border shadow-sm ${tasteTopics.includes(tag)
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-2" role="radiogroup" aria-label="책의 목적 선택">
                                    {TASTE_PURPOSES.map(purpose => (
                                        <button
                                            ...
                                            className={`px-4 py-3 rounded-lg text-base transition-all border text-center shadow-sm ${tastePurpose === purpose
                                                ? 'bg-accent/10 text-accent border-accent font-bold'
                                                : 'bg-background text-muted-foreground border-border hover:border-primary/30'
                                                }`}
                                        >
                                ...
                                <div className="grid grid-cols-3 gap-2" role="radiogroup" aria-label="원하는 난이도 선택">
                                    {TASTE_READING_LEVELS.map(level => (
                                        <button
                                            ...
                                            className={`px-4 py-3 rounded-lg text-base transition-all border text-center shadow-sm ${tasteReadingLevel === level
                                                ? 'bg-accent/10 text-accent border-accent font-bold'
                                                : 'bg-background text-muted-foreground border-border hover:border-primary/30'
                                                }`}
                                        >
                            ...
                            {/* Style Section */}
                            <div className="space-y-3">
                                <span className="text-base font-bold text-primary opacity-80 uppercase tracking-wider">선호 스타일 (참고용)</span>
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-2" role="radiogroup" aria-label="선호 스타일 선택">
                                    {TASTE_STYLES.map(style => (
                                        <button
                                            ...
                                            className={`px-4 py-3 rounded-lg text-base transition-all border text-center shadow-sm ${tasteStyle === style
                                                ? 'bg-accent/10 text-accent border-accent font-bold'
                                                : 'bg-background text-muted-foreground border-border hover:border-primary/30'
                                                }`}
                                        >
                        ...
                        <div className="flex justify-between items-center pt-4">
                            <button onClick={reset} className="text-muted-foreground hover:text-primary transition-colors text-base font-medium">처음으로</button>
                            <Button
                ...
                {mode === 'MIND' && !loading && !hasSearched && (
                    <section className="space-y-8 animate-fade-in" aria-labelledby="mind-title">
                        ...
                        <div className="space-y-6 bg-secondary p-8 rounded-xl border border-border shadow-sm">
                            ...
                            <div className="space-y-3">
                                <label htmlFor="mind-input" className="text-base font-bold text-primary uppercase tracking-wider flex justify-between">
                                    <span>상황 설명 (필수)</span>
                                ...
                                />
                                <div className="bg-[#FF5678]/10 border border-[#FF5678]/20 p-4 rounded-lg">
                            ...
                            {/* Want To Section */}
                            <div className="space-y-3">
                                <span className="text-base font-bold text-primary opacity-80 uppercase tracking-wider">책에서 원하는 것</span>
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-2" role="radiogroup" aria-label="책에서 원하는 것 선택">
                                    {MIND_WANT_TO.map(wantTo => (
                                        <button
                                            ...
                                            className={`px-4 py-3 rounded-lg text-base transition-all border text-center shadow-sm ${mindWantTo === wantTo
                            ...
                            <div className="space-y-3">
                                <span className="text-base font-bold text-primary opacity-80 uppercase tracking-wider">독서 무드</span>
                                <div className="grid grid-cols-2 gap-2" role="radiogroup" aria-label="독서 무드 선택">
                                    {MIND_READING_MOODS.map(mood => (
                                        <button
                                            ...
                                            className={`px-4 py-3 rounded-lg text-base transition-all border text-center shadow-sm ${mindReadingMood === mood
                                                ? 'bg-[#FF5678] text-white border-[#FF5678] font-bold'
                                                : 'bg-background text-muted-foreground border-border hover:border-primary/30'
                                                }`}
                                        >
                            ...
                            {/* Emotion Section */}
                            <div className="space-y-3">
                                <span className="text-base font-bold text-primary opacity-80 uppercase tracking-wider">감정/상태 키워드 (참고용)</span>
                                <div className="flex flex-wrap gap-2" role="group" aria-label="감정/상태 키워드 선택">
                                    {MIND_EMOTIONS.map(tag => (
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-full text-base transition-all border shadow-sm ${mindEmotions.includes(tag)
                                                ? 'bg-[#FF5678] text-white border-[#FF5678] font-bold'
                                                : 'bg-background text-muted-foreground border-border hover:border-primary/30'
                                                }`}
                                        >
                ...
                {!loading && hasSearched && (
                    <section className="space-y-12 animate-fade-in w-full text-center" aria-labelledby="results-title">
                        <div className="space-y-2">
                            <h2 id="results-title" className="text-3xl font-bold font-serif text-foreground">
                        ...
                        {result.length > 0 ? (
                            <>
                                <div className="grid gap-8">
                                    {result.map((book, i) => {
                                        const CardContent = (
                                            <article className="flex flex-col md:flex-row gap-6 bg-secondary/50 border border-border p-6 rounded-xl hover:border-accent hover:bg-secondary/80 transition-all cursor-pointer group h-full text-left relative shadow-sm">
                                                {/* Cover */}
                                                <div className="w-full md:w-32 flex-shrink-0">
                                                    <div className="aspect-[1/1.5] w-28 mx-auto md:w-full rounded-md overflow-hidden bg-muted relative shadow-lg group-hover:shadow-accent/20 transition-all border border-border">
                                                ...
                                                <div className="flex-1 space-y-4">
                                                    <div>
                                                        <div className="flex items-center gap-2 mb-1">
                                                            <span className={`text-base font-bold px-3 py-1.5 rounded bg-background border border-border uppercase tracking-wider ${mode === 'TASTE' ? 'text-accent' : 'text-[#FF5678]'}`}>
                                                        ...
                                                        <p className="text-base text-muted-foreground">{book.displayAuthor}</p>
                                                    </div>

                                                    <div className={`p-4 rounded-lg relative bg-background border ${mode === 'TASTE' ? 'border-accent/20' : 'border-[#FF5678]/20'}`}>
                                                    ...
                                                    <div className="flex flex-wrap gap-2 pt-2">
                                                        {book.coupangLink && (
                                                            <div 
                                                                className={`text-base font-bold px-6 py-3 rounded-md transition-all flex items-center gap-2 shadow-sm group-hover:shadow-md group-hover:-translate-y-0.5 ${
                                                                    mode === 'TASTE' 
                                                                    ? 'bg-accent text-primary-foreground group-hover:bg-accent/80' 
                                                                    : 'bg-[#FF5678] text-white group-hover:bg-[#FF5678]/80'
                                                                }`}
                                                            >
                                                        ...
                                                        <div className="text-sm text-muted-foreground flex items-center ml-auto opacity-0 group-hover:opacity-100 transition-opacity">
                                                            클릭하여 스토어로 이동 →
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div className="w-full flex flex-col items-center bg-secondary p-6 rounded-2xl border border-border shadow-sm mt-8 mb-8">
                                    <p className="text-muted-foreground mb-4 font-medium text-center text-lg">💡 추천받은 책, 쿠팡에서 바로 찾아보세요!</p>
                                    <div className="w-full overflow-hidden rounded-lg bg-background p-1 border border-border">
                                        <iframe src="https://coupa.ng/clGXS1" width="100%" height="44" frameBorder="0" scrolling="no" referrerPolicy="unsafe-url"></iframe>
                                    </div>
                                    <p className="text-muted-foreground/70 mt-4 text-center text-base">이 포스팅은 쿠팡 파트너스 활동의 일환으로, 이에 따른 일정액의 수수료를 제공받습니다.</p>
                                </div>
                            </>
                        ) : (
                            /* 2번 피드백 반영: 결과가 0건일 때 결과 페이지 하단에 노출될 Empty State 섹션 */
                            <div className="text-center py-16 space-y-6 animate-fade-in bg-secondary rounded-2xl border border-dashed border-border p-12">
                                <div className="w-20 h-20 bg-background rounded-full flex items-center justify-center mx-auto mb-4 border border-border shadow-sm">
                                    <Sparkles size={40} className="text-muted-foreground" />
                                </div>
                                <div className="space-y-3">
                                    <h3 className="text-2xl font-bold font-serif text-foreground">어울리는 책을 찾지 못했어요..</h3>
                                ...
                                <Button 
                                    ...
                                    className={`px-8 py-6 rounded-lg text-lg font-bold transition-all ${
                                        mode === 'TASTE' 
                                        ? 'bg-accent text-primary-foreground hover:bg-accent/80 shadow-md shadow-accent/20' 
                                        : 'bg-[#FF5678] text-white hover:bg-[#FF5678]/80 shadow-md shadow-[#FF5678]/20'
                                    }`}
                                >
                                    다시 자세히 적어보기
                                </Button>
                        ...
                        <div className="text-center pt-10">
                            <Button onClick={reset} variant="outline" className="border-border text-muted-foreground hover:text-foreground hover:bg-secondary text-base py-6 px-8" aria-label="추천 다시 받으러 가기">
