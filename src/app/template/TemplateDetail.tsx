        ...
        <div className="flex flex-col w-full max-w-screen-sm mx-auto overflow-x-hidden font-sans space-y-12 pb-16">
            ...
            <section className="flex flex-col gap-8 text-foreground">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <p className="text-muted-foreground text-xl font-medium leading-snug">
                        문장과 생각을 쌓는 독서관
                    </p>
            ...
            <section className="bg-secondary/50 rounded-2xl py-12 px-6">
                <h2 className="text-foreground text-2xl font-bold mb-8 px-2">주요 특징</h2>
                <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col gap-4 p-5 rounded-2xl bg-secondary border border-border shadow-sm">
                        <div className="w-10 h-10 rounded-lg bg-accent/10 flex items-center justify-center text-2xl drop-shadow-md">
                            ⚡️
                        </div>
                        <div>
                            <p className="text-foreground text-base font-bold mb-1">빠른 실행</p>
                            <p className="text-muted-foreground text-xs leading-relaxed">책 추가, 하이라이트를 대시보드에서 즉시 생성</p>
                        </div>
                    </div>
                    <div className="flex flex-col gap-4 p-5 rounded-2xl bg-secondary border border-border shadow-sm">
                        <div className="w-10 h-10 rounded-lg bg-accent/10 flex items-center justify-center text-2xl drop-shadow-md">
                        ...
                        <div>
                            <p className="text-foreground text-base font-bold mb-1">체계적 관리</p>
                            <p className="text-muted-foreground text-xs leading-relaxed">서재와 하이라이트를 상세 페이지로 자동 정리</p>
                        </div>
                    </div>
                    <div className="flex flex-col gap-4 p-5 rounded-2xl bg-secondary border border-border shadow-sm">
                        <div className="w-10 h-10 rounded-lg bg-accent/10 flex items-center justify-center text-2xl drop-shadow-md">
                        ...
                        <div>
                            <p className="text-foreground text-base font-bold mb-1">기록의 질</p>
                            <p className="text-muted-foreground text-xs leading-relaxed">양보다 질에 집중하는 하이라이트 중심 구조</p>
                        </div>
                    </div>
                    <div className="flex flex-col gap-4 p-5 rounded-2xl bg-secondary border border-border shadow-sm">
                        <div className="w-10 h-10 rounded-lg bg-accent/10 flex items-center justify-center text-2xl drop-shadow-md">
                        ...
                        <div>
                            <p className="text-foreground text-base font-bold mb-1">독서 습관</p>
                            <p className="text-muted-foreground text-xs leading-relaxed">챌린지 기능으로 꾸준한 독서 루틴 형성</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            {/* Usage Flow */}
            <section className="bg-secondary/30 rounded-2xl py-16 px-6 relative overflow-hidden">
                <h2 className="text-foreground text-2xl font-bold mb-10 text-center">간편하게 만드는 독서 습관과 기록 아카이브</h2>
                <div className="relative">
                    <div className="absolute left-4 top-0 bottom-0 w-0.5 bg-accent/30"></div>
                    <div className="flex flex-col gap-8">
                        <div className="flex gap-6 items-start relative">
                            <div className="w-8 h-8 rounded-full bg-accent text-primary-foreground flex items-center justify-center font-bold z-10 shrink-0">1</div>
                            <div className="flex flex-col pt-1">
                                <h4 className="font-bold text-foreground text-lg">책 추가하기</h4>
                                <p className="text-muted-foreground text-sm">서재에 읽고 싶은 책을 등록합니다.</p>
                            </div>
                        </div>
                        <div className="flex gap-6 items-start relative">
                            <div className="w-8 h-8 rounded-full bg-accent text-primary-foreground flex items-center justify-center font-bold z-10 shrink-0">2</div>
                            <div className="flex flex-col pt-1">
                                <h4 className="font-bold text-foreground text-lg">읽기 시작하기</h4>
                                <p className="text-muted-foreground text-sm">독서 상태를 &apos;읽는 중&apos;으로 변경합니다.</p>
                            </div>
                        </div>
                        <div className="flex gap-6 items-start relative">
                            <div className="w-8 h-8 rounded-full bg-accent text-primary-foreground flex items-center justify-center font-bold z-10 shrink-0">3</div>
                            <div className="flex flex-col pt-1">
                                <h4 className="font-bold text-foreground text-lg">하이라이트 남기기</h4>
                                <p className="text-muted-foreground text-sm">인상 깊은 문장과 내 생각을 기록합니다.</p>
                            </div>
                        </div>
                        <div className="flex gap-6 items-start relative">
                            <div className="w-8 h-8 rounded-full bg-accent text-primary-foreground flex items-center justify-center font-bold z-10 shrink-0">4</div>
                            <div className="flex flex-col pt-1">
                                <h4 className="font-bold text-foreground text-lg">완독 기록하기</h4>
                                <p className="text-muted-foreground text-sm">읽은 날짜와 평점을 기록하며 마무리합니다.</p>
                            </div>
                        </div>
                        <div className="flex gap-6 items-start relative">
                            <div className="w-8 h-8 rounded-full bg-accent text-primary-foreground flex items-center justify-center font-bold z-10 shrink-0">5</div>
                            <div className="flex flex-col pt-1">
                                <h4 className="font-bold text-foreground text-lg">챌린지로 습관 만들기</h4>
                                <p className="text-muted-foreground text-sm">성취감을 느끼며 다음 책으로 이어갑니다.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-16 px-4">
                <h2 className="text-foreground text-2xl font-bold mb-8 text-center font-display">이런 분들께 추천해요</h2>
                <div className="space-y-3">
                    <div className="flex items-center gap-4 p-5 bg-secondary rounded-2xl border border-border shadow-sm">
                        <span className="text-2xl drop-shadow-md">📝</span>
                        <p className="text-foreground font-medium">책을 읽고도 기록이 남지 않는 사람</p>
                    </div>
                    <div className="flex items-center gap-4 p-5 bg-secondary rounded-2xl border border-border shadow-sm">
                        <span className="text-2xl drop-shadow-md">💖</span>
                        <p className="text-foreground font-medium">인상 깊은 문장을 모아두고 싶은 사람</p>
                    </div>
                    <div className="flex items-center gap-4 p-5 bg-secondary rounded-2xl border border-border shadow-sm">
                        <span className="text-2xl drop-shadow-md">📈</span>
                        <p className="text-foreground font-medium">독서 습관을 만들고 싶은 사람</p>
                    </div>
                    <div className="flex items-center gap-4 p-5 bg-secondary rounded-2xl border border-border shadow-sm">
                        <span className="text-2xl drop-shadow-md">🎨</span>
            ...
            <section className="py-16 px-6 bg-secondary/50 rounded-2xl">
            ...
            <section className="py-20 px-6 bg-secondary rounded-2xl flex flex-col items-center text-center gap-6 shadow-sm border border-border">
